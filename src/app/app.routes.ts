...
export const routes: Routes = [
    ...
    { path: 'booking-details', loadComponent: () => import('./components/main/booking-details/booking-details.component').then(m => m.BookingDetailsComponent), canActivate: [AuthGuard] },
    {
        ...
        children: [
            ...
            { path: 'currency-management', loadComponent: () => import('./components/main/currency-management/currency-management.component').then(m => m.CurrencyManagementComponent), canActivate: [AuthGuard] },
            ...
            { path: 'transaction-history', loadComponent: () => import('./components/main/transaction-history/transaction-history.component').then(m => m.TransactionHistoryComponent), canActivate: [AuthGuard] },
